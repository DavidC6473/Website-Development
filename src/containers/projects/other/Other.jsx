...
I built this website using JavaScript, HTML, CSS, and React, taking pride in crafting every element from scratch, including the ChatBot. The website showcases my skills in full-stack web development and features a ChatBot that adds interactivity and enhances the user experience. The ChatBot was developed using JavaScript and integrated with wit.ai, a natural language processing platform, to enable intelligent conversation handling. If you're interested in exploring the code and understanding the implementation details, you can find it on my GitHub repository.</p>
        <p className='nba-paragraph'><a className='nba-link' href='https://github.com/DavidC6473/Website-Development' target='_blank'>Github Link</a></p>
        ...
        <p className='nba-paragraph'><a className='nba-link' href='https://github.com/DavidC6473/music-genre-classifier' target='_blank'>Github Link</a></p>
        ...
        <p className='nba-paragraph'><a className='nba-link' href='https://github.com/DavidC6473/Wengs-Algorithm-And-Grey-World-For-White-Balancing' target='_blank'>Github Link</a></p>
        ...
        <p className='nba-paragraph'><a className='nba-link' href='https://github.com/DavidC6473/Systematic-MIDI-Extraction-Ableton' target='_blank'>Github Link</a></p>
        ...
        <p className='nba-paragraph'><a className='nba-link' href='https://github.com/DavidC6473/Automate-Ableton-Collect-And-Save' target='_blank'>Github Link</a></p>
        ...
        <p className='nba-paragraph'><a className='nba-link' href='https://github.com/DavidC6473/Python-GIMP-Poster' target='_blank'>Github Link</a></p>
        ...
        <p className='nba-paragraph'><a className='nba-link' href='https://github.com/DavidC6473/Java-Pronoun-Use-Movies' target='_blank'>Github Link</a></p>
